...
int main(){
	...
	//FUNCIÓN QUE CREE UN STRING CADENA DE TEXTO CON LA INFORMACION DEL ESTUDIANTE. PEDES EMPEZAR CREANDO UNA FUNCION QUE IMPRIMA LA INFOPR DEL ESTUDIANTE POR PANTALLA
